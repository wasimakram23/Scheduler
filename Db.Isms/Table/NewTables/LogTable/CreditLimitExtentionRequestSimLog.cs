...
{
    public class CreditLimitExtentionRequestSimLog
    {
        public long LogId { get; set; }
        public CreditLimitExtentionRequestSim LogFor { get; set; }
        public DateTime? LogDateTime { get; set; }



        public int CreditLimitExtentionRequestId { get; set; }       /*Fk RequisitionRequest id*/
